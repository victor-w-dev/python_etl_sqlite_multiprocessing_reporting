...
class ExcelOutput(object):
    ...
    def __init__(self, reportdata_dict):
        self.TX_dict = reportdata['TX']
        self.DX_dict = reportdata['DX']
        self.RX_dict = reportdata['RX']
        self.IM_dict = reportdata['IM']

    def money_conversion(data,currency='HKD',money='MN'):
