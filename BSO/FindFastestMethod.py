...
#new.get_hsccit(2018, month='12')
#new.get_hscoit(2018, month='12')
#new.get_hscoccit(2018, month='12')
    #mergedf(startyear=2015, endperiod=2018, type="hsccit") #14.24s #13.96 #11.06s
    mergedf_multiprocessing(startyear=2016, endperiod=201907, type="hsccit") #8s
